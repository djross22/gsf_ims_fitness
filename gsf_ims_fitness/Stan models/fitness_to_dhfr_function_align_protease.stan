...
parameters {
  vector[N_sal] log_ec50_prot;      //log10 of the ec50 for the fraction_intact curve vs. protease expression
  //vector[N_sal] log_fraction_inf;   //log10 of the saturated value for the fraction_intact curve vs. protease expression (at infinite protease)
  real log_fraction_inf;   //log10 of the saturated value for the fraction_intact curve vs. protease expression (at infinite protease)
